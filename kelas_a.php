...
// Mengambil data dari tabel kelas_a
$sql = "SELECT id, jabatan, nama, no_induk FROM kelas_a";
...
<div class="block">
    <div class="block-judul">Kelas A</div>
    <form action="submit_data.php?kelas=kelas_a" method="POST">
...
<div id="resultContainer">
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            ...
            echo "<input type='hidden' name='kelas' value='kelas_a'>";
