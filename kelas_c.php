...
// Mengambil data dari tabel kelas_c
$sql = "SELECT id, jabatan, nama, no_induk FROM kelas_c";
...
<div class="block">
    <div class="block-judul">Kelas C</div>
    <form action="submit_data.php?kelas=kelas_c" method="POST">
...
<div id="resultContainer">
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            ...
            echo "<input type='hidden' name='kelas' value='kelas_c'>";
